...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/Palette/PaletteDisplay.js":[function(require,module,exports) {
function generatePaletteGridPane() {
  var elementTree = document.createDocumentFragment();
  ...
  grid.id = "palette-grid__grid"; // container.appendChild(title);

  container.appendChild(grid);
  elementTree.appendChild(container);
  return elementTree; //main.appendChild(elementTree);
}
...
function generateColorCards(cssNames, colorValues) {
  var cards = [];
  var finalIndex = Math.min(cssNames.length, colorValues.length);
...
function addColorCardsToPaletteGrid(gridTree, cards) {
  var grid = gridTree.querySelector("#palette-grid__grid");
...
},{}]},{},["../../../Users/cmatt/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/Palette/PaletteDisplay.js"], null)
//# sourceMappingURL=/PaletteDisplay.8387b259.js.map